#ifndef RBTREETABLE_RBTREETABLE_H
#define RBTREETABLE_RBTREETABLE_H
...
class RBTreeTable : ITable<TKey, TValue> {
...
public:
    ...
    friend std::ostream& operator<<(std::ostream& out, const RBTreeTable<TKey, TValue>& table) {
...
private:
    void print_rec(RBNode<TKey, TValue>*) const noexcept;
    void print_row(const TKey&, const TValue&) const noexcept;
};
template <class TKey, class TValue>
RBTreeTable<TKey, TValue>::RBTreeTable() : _rows() {}

template <class TKey, class TValue>
void RBTreeTable<TKey, TValue>::print_rec(RBNode<TKey, TValue>* node) const noexcept {
...
template <class TKey, class TValue>
void RBTreeTable<TKey, TValue>::print_row(const TKey& key, const TValue& value) const noexcept {
...
#endif // !RBTREETABLE_RBTREETABLE_H