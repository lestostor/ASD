#ifndef AVLTREETABLE_AVLTREETABLE_H
#define AVLTREETABLE_AVLTREETABLE_H
...
class AVLTreeTable : ITable<TKey, TValue> {
...
public:
    ...
    friend std::ostream& operator<<(std::ostream& out, const AVLTreeTable<TKey, TValue>& table) {
...
private:
    void print_rec(AVLNode<TKey, TValue>*) const noexcept;
    void print_row(const TKey&, const TValue&) const noexcept;
};
template <class TKey, class TValue>
AVLTreeTable<TKey, TValue>::AVLTreeTable() : _rows() {}

template <class TKey, class TValue>
void AVLTreeTable<TKey, TValue>::print_rec(AVLNode<TKey, TValue>* node) const noexcept {
...
template <class TKey, class TValue>
void AVLTreeTable<TKey, TValue>::print_row(const TKey& key, const TValue& value) const noexcept {
...
#endif // !AVLTREETABLE_AVLTREETABLE_H
